...
class PetController extends Controller
{
     ...
     * @return Response The Symfony response.
     */
    public function findPetsByStatusAction(Request $request): Response
    {
     ...
     * @return Response The Symfony response.
     */
    public function findPetsByTagsAction(Request $request): Response
    {
        // Figure out what data format to return to the client
        $produces = ['application/xml', 'application/json'];
        // Figure out what the client accepts
     ...
     * @return Response The Symfony response.
     */
    public function updatePetAction(Request $request): Response
    {
        // Make sure that the client is providing something that we can consume
        $consumes    = ['application/json', 'application/xml'];
        $inputFormat = $request->headers->has('Content-Type') ? $request->headers->get('Content-Type') : $consumes[0];
     ...
     */
    public function getApiHandler(): PetApiInterface
    {
